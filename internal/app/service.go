...
type Service struct { GitHub *ghapi.Client; Worktrees *worktree.Manager; GraphReader *graph.Reader; DiffReader *diff.Reader; LocalRoot string; Launcher *launch.SessionManager; LaunchRegistry launch.Registry }
